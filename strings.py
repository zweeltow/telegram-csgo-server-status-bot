...
dc_tags = ["dc", "data center", "data centers", 
                    "дц", "дата центер", "дата центры"]
# Detailed
south_american_tags = ["sa", "south america", "brazil", "sao paolo", "chile", "santiago", "peru", "lima", 
                    "южная америка", "бразилия", "сан-паулу", "сан паулу", "чили", "сантьяго", "перу", "лима"]
...
north_american_tags = ["northcentral", "northeast", "northwest", "chicago", "sterling", "moses lake", 
                    "северо-центр", "северо-восток", "северо-запад", "чикаго", "стерлинг", "мозес лейк"]
south_american_tags = ["southeast", "southwest", "los angeles", "atalanta", 
